...
def createOutput(workingDir, appNet, appProviders, appPermissions, appFeatures,
    ...
    if not os.path.exists(os.path.join(workingDir, 'data_set')):
        os.mkdir(os.path.join(workingDir, 'data_set'))
    ...
    outpath = os.path.join(workingDir, 'data_set/train_dataset.json')
